...
export default function SpecialistSignUp() {
  ...
  const userType = location.pathname.includes('clinical-manager') ? 'Clinical Manager' : 'Specialist';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log(`${userType} signup:`, formData, { preregistration });
    // Redirect based on preregistration or navigate to home
    if (preregistration) {
      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {userType === 'Clinical Manager'
              ? 'Sign up to manage your clinic and staff'
              : 'Sign up to join as a healthcare professional'}
          </p>
        </div>
